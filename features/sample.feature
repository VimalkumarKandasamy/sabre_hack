...
Feature: Sample
    ...
    Background:
        ...
        And I have added the following participants of type org.nec.hack.SampleParticipant
            | participantId   | firstName | lastName |
            | alice@email.com | Alice     | A        |
            | bob@email.com   | Bob       | B        |
        And I have added the following assets of type org.nec.hack.SampleAsset
            | assetId | owner           | value |
            | 1       | alice@email.com | 10    |
            | 2       | bob@email.com   | 20    |
        And I have issued the participant org.nec.hack.SampleParticipant#alice@email.com with the identity alice1
        And I have issued the participant org.nec.hack.SampleParticipant#bob@email.com with the identity bob1

    Scenario: Alice can read all of the assets
        When I use the identity alice1
        Then I should have the following assets of type org.nec.hack.SampleAsset
            | assetId | owner           | value |
            | 1       | alice@email.com | 10    |
            | 2       | bob@email.com   | 20    |
    ...
    Scenario: Alice can add assets that she owns
        When I use the identity alice1
        And I add the following asset of type org.nec.hack.SampleAsset
            | assetId | owner           | value |
    ...
    Scenario: Alice can update her assets
        When I use the identity alice1
        And I update the following asset of type org.nec.hack.SampleAsset
            | assetId | owner           | value |
    ...
    Scenario: Alice can remove her assets
        When I use the identity alice1
        And I remove the following asset of type org.nec.hack.SampleAsset
            | assetId |
            | 1       |
        Then I should not have the following assets of type org.nec.hack.SampleAsset
            | assetId |
            | 1       |
    ...
    Scenario: Alice can submit a transaction for her assets
        When I use the identity alice1
        And I submit the following transaction of type org.nec.hack.SampleTransaction
            | asset | newValue |
            | 1     | 50       |
        Then I should have the following assets of type org.nec.hack.SampleAsset
            | assetId | owner           | value |
            | 1       | alice@email.com | 50    |
        And I should have received the following event of type org.nec.hack.SampleEvent
